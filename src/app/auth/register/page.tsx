...
const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await axios.post<RegisterResponse>(`${apiUrl}/api/auth/register-user`, {
        name,
        email,
        password
      });
      ...
      if (response.data) {
        ...
        } else if (response.data.success || response.data.message?.toLowerCase().includes('success')) {
